...
const appId: string = "908139c38db54499919f6b93053f226c"; //ENTER APP ID HERE
const token: string | null = "006908139c38db54499919f6b93053f226cIADxD0wRfN01eXY1CX1BwiLHGd3lp3D5X+6YeLbwb0j6voAO3FUAAAAAEADBxArjePiWYgEAAQB4+JZi";
...
export const Rtc = () => {
  ...
  return (
    <div>
      <h1 className="heading">视频会议Demo</h1>
      {inCall ? (
        <VideoCall setInCall={setInCall} channelName={'demo1'} />
      ) : (
